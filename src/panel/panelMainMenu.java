...
public class panelMainMenu extends JPanel implements MouseListener{
	...
	public panelMainMenu() {		
		...
		lblSale.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/Sale_96.png")));
		...
		lblImport.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/Import_96.png")));
		...
		lblBooking.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/Booking_96.png")));
		...
		lblTable.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/Table_96.png")));
		...
		lblProduct.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/Product_96.png")));
		...
		lblRawMaterial.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/RawMaterial_96.png")));
		...
		lblType.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/Category_96.png")));
		...
		lblUserAccount.setIcon(new ImageIcon(panelMainMenu.class.getResource("/Resources/User_96.png")));
	...
	public void mouseClicked(MouseEvent e) {	
		if(e.getSource() == lblSale) {
			...
			panelBooking booking = new panelBooking();
